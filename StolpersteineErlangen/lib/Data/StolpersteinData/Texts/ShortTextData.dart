String sh_Bauer_Amalia_dt = "";
String sh_Bauer_Ernestine_dt = "";
String sh_Bauer_Josef_dt = "";
String sh_Bauer_Simon_dt = "";
String sh_Benesi_Erich_dt = "";
String sh_Benesi_Gottliebe_dt = "";
String sh_Benesi_Hannelore_dt = "";
String sh_Benesi_Hildegard_dt = "";
String sh_Benesi_Jakob_dt = "";
String sh_Cohn_Alfred_dt = "";
String sh_Cohn_Rosa_dt = "";
String sh_Dreifuss_Adolf_dt = "";
String sh_Fleischhauer_Bertha_dt = "";
String sh_Heyer_Gustav_dt = "";
String sh_Katz_Wilma_dt = "";
String sh_Rotenstein_Jenny_dt = "";
String sh_Rotenstein_Simon_dt = "";
String sh_Rotenstein_Sophie_dt = "";
String sh_Uhlfelder_Frieda_dt = "";
String sh_Uhlfelder_Josef_dt = "";
String sh_Vissing_Hildegard_dt = "";
String sh_Wassermann_Thekla_dt = "";
String sh_Weglein_Klothilde_dt = "";
String sh_Weglein_Samuel_dt = "";
String sh_Weinstock_Ivan_dt = "";
String sh_Wild_Ignatz_dt = "";
String sh_Wild_Paula_dt = "";
